...
export default function UserDashboardPage() {
    ...
    const fetchAndAnalyze = useCallback(async () => {
        try {
            ...
            // NOTE: This uses the same admin-focused insight generation for now.
            // In a real application, you might have a separate, user-focused AI flow.
  ...
  return (
        <div className="flex flex-col gap-8 p-4 md:p-6 lg:p-8 bg-background min-h-screen">
          ...
          <main className="flex flex-col gap-6">
             {loading ? (
              ...
              <>
                ...
                <SocialMediaInsights insights={mapInsights} isAdminView={false} />
              </>
            ) : null}
          </main>
        </div>
